...
function extractSources(content: string): {
  ...
  if (sourceMatch) {
    const sources = sourceMatch[1]
      ? sourceMatch[1].split(",").filter(Boolean)
      : [];
...
export default function ImmigrationChatbot() {
  ...
  }, [prefill, messages.length, setInput]);
            ...
            {messages.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4 max-w-md mx-auto">
                  Get reliable information about your rights when encountering
                              ...
                              !sources.includes("fallback-kb") ? (
                                ...
                                >
                                  ...
                                  <span className="text-xs">
                                    Information not verified - Contact a lawyer
                                  </span>
                                </Button>
                              )}
                            </div>
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xs text-gray-500 text-center mt-2">
            This provides general information only. Consult an immigration
